...
import com.google.android.apps.iosched2.provider.ScheduleContract.BlocksColumns;
import com.google.android.apps.iosched2.provider.ScheduleContract.Rooms;
import com.google.android.apps.iosched2.provider.ScheduleContract.RoomsColumns;
import com.google.android.apps.iosched2.provider.ScheduleContract.Sessions;
import com.google.android.apps.iosched2.provider.ScheduleContract.SessionsColumns;
import com.google.android.apps.iosched2.provider.ScheduleContract.Speakers;
import com.google.android.apps.iosched2.provider.ScheduleContract.SpeakersColumns;
...
import com.google.android.apps.iosched2.provider.ScheduleContract.TracksColumns;
...
public class ScheduleDatabase extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (version < VER_GDD_JP_UTF8_UPDATE) {
        	//&& Setup.EVENT_ID_SELECTED == SetupJP.EVENT_ID_SELECTED_NAME) {
        	Log.d(TAG, "upgrade VER_GDD_JP_UTF8_UPDATE logic, at version " + version);
