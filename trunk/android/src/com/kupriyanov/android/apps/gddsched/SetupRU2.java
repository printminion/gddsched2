...
public class SetupRU2 implements ISetup {

	public static int BLOCKS_XML = xml.ru2_blocks;
	public static int ROOMS_XML = xml.ru2_rooms;
	 ...
	 */
	public static final String TIME_ZONE = "+0400"; // RFC 822 - time zone
	public static final String TIME_ZONE_SPLITTED = "+04:00"; // RFC 822 - time

	public static final long CONFERENCE_START_MILLIS_DAY1 = ParserUtils.parseTime("2011-10-10T08:00:00.000+04:00");
	public static final long CONFERENCE_END_MILLIS_DAY1 = ParserUtils.parseTime("2011-10-10T19:00:00.000+04:00");
	...
	public static final String EVENT_ID_SELECTED_NAME = "RU";
	...
	public static final String EVENT_PREFIX = "ru2_";
